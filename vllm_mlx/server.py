...
Examples:
    ...
    parser.add_argument("--draft-block-tokens", type=str, default=None, help="DFlash speculative draft block length; integer, or auto for measured per-drafter defaults")
