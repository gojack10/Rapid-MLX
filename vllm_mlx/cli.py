...
Examples:
  ...
  rapid-mlx models
    ...
    serve_parser.add_argument("--draft-block-tokens", type=str, default=None, help="DFlash speculative draft block length; integer, or auto for measured per-drafter defaults")
    ...
    serve_parser.add_argument("--speculative-mode", choices=("dflash", "ddtree"), default=None, help="Speculative decoding mode: dflash (block diffusion) or ddtree (tree verifier)")
    serve_parser.add_argument("--ddtree-budget", type=int, default=None, help="DDTree node budget (max tokens per verify, default 32)")
    ...
    serve_parser.add_argument("--ddtree-use-log-softmax", action="store_true", default=None, help="Use actual log-softmax probabilities instead of centered scores")
    serve_parser.add_argument("--ddtree-min-log-prob", type=float, default=None, help="Prune DDTree paths below cumulative log-prob threshold (e.g. -4)")
    serve_parser.add_argument("--ddtree-max-depth", type=int, default=None, help="Maximum DDTree tree depth (0=unlimited)")
    serve_parser.add_argument("--ddtree-depth-penalty", type=float, default=None, help="Per-depth penalty on child cumulative score")
    serve_parser.add_argument("--ddtree-dynamic-threshold", type=str, default=None, help="Dynamic threshold mode: mean_top1_x40 or pos1_top1_x30")
    serve_parser.add_argument("--ddtree-truncate-logw", type=float, default=None, help="Truncate tree at first node below this cumulative logw")
